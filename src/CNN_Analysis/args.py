...
Model_Names = {'pretrained':{'resnet50':'ResNet50', 'vgg16':'VGG16', 'alexnet':'AlexNet'},
               'untrained' :{'resnet50':'Random_ResNet50', 'vgg16':'Random_VGG16', 'alexnet':'Random_AlexNet'}}

## Definition of the subspaces for the train/test split of the coarse-grained generalization
SubSpace = {1:[Artificials, Tools],
...
nSampledPairs = [4, 12, 20, 28, 36, 44, 52, 60, 68, 76, 84, 92, 100]; nSampling = len(nSampledPairs)
